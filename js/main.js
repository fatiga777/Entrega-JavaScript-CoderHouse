...
while(continuar) {
    ...
    switch(menu) {
        case 2006:
            ...
            break
        case 2010:
            alert("Lionel Messi ganó el Balón de Oro en 2010 sin marcar un solo gol en el Mundial y fue eliminado por Alemania en octavos de final con una goleada de 4-0")
            break
        case 2014:
        ...
        case 2022:
            ...
            break
        case 2026:
            alert("No estaba entre las opciones, pero Ojala lo juege y gane otra vez, Te amo Leo <3")
            break
        default:
